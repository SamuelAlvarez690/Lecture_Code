# Lecture: FunctionalStylePartI and FunctionalStylePartII
# Summary: In this program we explore functional programming and how to calculate total with inject with Ruby.
